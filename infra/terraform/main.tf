...
resource "aws_instance" "app_server" {
  ...
  user_data = <<-EOF
              ...
              git clone https://MphoNkutha:${var.github_token}@github.com/MphoNkutha/KuduNav-Rental.git /home/ec2-user/app
...
resource "aws_eip_association" "eip_assoc" {
  ...
  allocation_id = "eipalloc-086a01b5f16d008a3"  # Use your actual Elastic IP allocation ID
}
